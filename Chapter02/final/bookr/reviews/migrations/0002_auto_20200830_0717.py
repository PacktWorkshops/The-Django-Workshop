# Generated by Django 3.0a1 on 2020-08-30 07:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(help_text='The contact email for the contributor.', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Review',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('AUTHOR', 'Author'), ('CO_AUTHOR', 'Co-Author'), ('EDITOR', 'Editor')], max_length=50, verbose_name='The role this contributor had in the book.')),
